<div class="w-full mx-auto p-6 bg-white rounded-lg shadow-md  border-dashed">
    ...
    <form class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            <label for="" class="block text-sm font-medium text-gray-700">Section</label>
            <select name="section" id="section" class="mt-1 block w-full rounded-md border border-gray-300 p-2">
                <option value="">Select</option>
